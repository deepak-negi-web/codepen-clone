...
h-16 sticky top-0 backdrop-blur-sm padding[1rem 4rem]
flex items-center justify-between
 border[1px solid var(--primary-border-color)] border-l-0 border-r-0
 z-10
[> .ant-menu, .ant-menu.ant-menu-dark]:(background[var(--secondary-background)] text-white  border-none)
[> .ant-menu > .ant-menu-item]:(background[var(--secondary-background)] mr-1 last:(mr-0) hover:background[var(--tertiary-background)] hover:(after:content[none]) )
